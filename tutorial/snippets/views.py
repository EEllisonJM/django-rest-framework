...
# Refactor SnippetList, SnippetDetail and SnippetHighlight view classes.
...
# - URL patterns are identified by convenience names that we
# will declare later on in our snippets/urls.py.
...
# # Better separation between the different HTTP methods.
